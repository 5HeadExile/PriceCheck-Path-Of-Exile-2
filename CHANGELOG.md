...
### Changed
- Визуал v2: непрозрачный нейтрально-тёмный фон плашек (исправляет фиолетовый
  оттенок от смешивания с magenta-ключом) и сдержанная приглушённая палитра тиров;
  лучшая награда — мягкая золотая рамка.
- Визуал оверлея: тёмные скруглённые плашки под ценами (контраст на любом фоне),
  цвет по тиру ценности, подсветка лучшей награды (★ + свечение), авто-единицы
  div/ex, fade-in при появлении, плашки не обрезаются за краем экрана, итог Σ —
  отдельной плашкой над областью.
